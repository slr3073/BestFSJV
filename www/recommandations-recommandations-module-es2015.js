...
const routes = [
    {
        ...
        children: [
            {
                path: 'films',
                loadChildren: () => Promise.all(/*! import() | films-films-module */[__webpack_require__.e("common"), __webpack_require__.e("films-films-module")]).then(__webpack_require__.bind(null, /*! ./films/films.module */ "./src/app/recommandations/films/films.module.ts")).then((m) => m.FilmsPageModule)
            },
            {
                path: 'series',
                loadChildren: () => Promise.all(/*! import() | series-series-module */[__webpack_require__.e("common"), __webpack_require__.e("series-series-module")]).then(__webpack_require__.bind(null, /*! ./series/series.module */ "./src/app/recommandations/series/series.module.ts")).then((m) => m.SeriesPageModule)
            },
            {
                path: 'jeux-video',
                loadChildren: () => Promise.all(/*! import() | jeux-video-jeux-video-module */[__webpack_require__.e("common"), __webpack_require__.e("jeux-video-jeux-video-module")]).then(__webpack_require__.bind(null, /*! ./jeux-video/jeux-video.module */ "./src/app/recommandations/jeux-video/jeux-video.module.ts")).then((m) => m.JeuxVideoPageModule)
            },
            {
                path: '',
...
let RecommandationsPageRoutingModule = class RecommandationsPageRoutingModule {
};
...
let RecommandationsPageModule = class RecommandationsPageModule {
};
...
let RecommandationsPage = class RecommandationsPage {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=recommandations-recommandations-module-es2015.js.map