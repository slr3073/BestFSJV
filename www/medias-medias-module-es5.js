...
var routes = [
    {
        ...
        children: [
            {
                path: 'films',
                loadChildren: function () { return Promise.all(/*! import() | films-films-module */[__webpack_require__.e("common"), __webpack_require__.e("films-films-module")]).then(__webpack_require__.bind(null, /*! ./films/films.module */ "./src/app/medias/films/films.module.ts")).then(function (m) { return m.FilmsPageModule; }); }
            },
            {
                path: 'series',
                loadChildren: function () { return Promise.all(/*! import() | series-series-module */[__webpack_require__.e("common"), __webpack_require__.e("series-series-module")]).then(__webpack_require__.bind(null, /*! ./series/series.module */ "./src/app/medias/series/series.module.ts")).then(function (m) { return m.SeriesPageModule; }); }
            },
            {
                path: 'jeux-video',
                loadChildren: function () { return Promise.all(/*! import() | jeux-video-jeux-video-module */[__webpack_require__.e("common"), __webpack_require__.e("jeux-video-jeux-video-module")]).then(__webpack_require__.bind(null, /*! ./jeux-video/jeux-video.module */ "./src/app/medias/jeux-video/jeux-video.module.ts")).then(function (m) { return m.JeuxVideoPageModule; }); }
            },
            {
                path: '',
...
var MediasPageRoutingModule = /** @class */ (function () {
    function MediasPageRoutingModule() {
    }
    ...
    return MediasPageRoutingModule;
}());
...
var MediasPageModule = /** @class */ (function () {
    function MediasPageModule() {
    }
...
var MediasPage = /** @class */ (function () {
    function MediasPage() {
    }
    MediasPage.prototype.ngOnInit = function () { };
...
//# sourceMappingURL=medias-medias-module-es5.js.map