...
const routes = [
    ...
    {
        path: 'ajouter-film',
        loadChildren: () => Promise.all(/*! import() | ajouter-film-ajouter-film-module */[__webpack_require__.e("common"), __webpack_require__.e("ajouter-film-ajouter-film-module")]).then(__webpack_require__.bind(null, /*! ./ajouter-film/ajouter-film.module */ "./src/app/selection/selectionner-film/ajouter-film/ajouter-film.module.ts")).then((m) => m.AjouterFilmPageModule)
    }
];
let SelectionnerFilmPageRoutingModule = class SelectionnerFilmPageRoutingModule {
};
...
let SelectionnerFilmPageModule = class SelectionnerFilmPageModule {
};
...
let SelectionnerFilmPage = class SelectionnerFilmPage {
    constructor(serviceFilm, navCtrl) {
        this.serviceFilm = serviceFilm;
        this.navCtrl = navCtrl;
        this.films = [...serviceFilm.filmNonVu];
    }
    ngOnInit() {
        this.filmSub = this.serviceFilm.filmNonVuChanged.subscribe((film) => {
            this.films = film;
        });
    }
    ngOnDestroy() {
...
SelectionnerFilmPage.ctorParameters = () => [
...
//# sourceMappingURL=selection-selectionner-film-selectionner-film-module-es2015.js.map