...
var JeuxVideoPageRoutingModule = /** @class */ (function () {
    function JeuxVideoPageRoutingModule() {
    }
    ...
    return JeuxVideoPageRoutingModule;
}());
...
var JeuxVideoPageModule = /** @class */ (function () {
    function JeuxVideoPageModule() {
    }
...
var JeuxVideoPage = /** @class */ (function () {
    function JeuxVideoPage(navCtrl, jeuVideoService) {
        this.navCtrl = navCtrl;
        this.jeuVideoService = jeuVideoService;
        this.mesJeuxVideo = jeuVideoService.myJeuVideo.slice();
    }
    JeuxVideoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.jeuVideoSub = this.jeuVideoService.myJeuVideoChanged.subscribe(function (jv) {
            _this.mesJeuxVideo = jv;
        });
    };
    JeuxVideoPage.prototype.ngOnDestroy = function () {
        this.jeuVideoSub.unsubscribe();
    };
    JeuxVideoPage.prototype.goToAjouter = function () {
        this.navCtrl.navigateForward(['selectionner-jeu-video']);
    };
    JeuxVideoPage.prototype.showInfo = function (id) {
        this.navCtrl.navigateForward(['/info-jeu-video/' + id]);
    };
    JeuxVideoPage.ctorParameters = function () { return [
...
var JeuxVideoPage = /** @class */ (function () {
    function JeuxVideoPage(router, jeuVideoService, alertCtrl) {
        this.router = router;
        this.jeuVideoService = jeuVideoService;
        this.alertCtrl = alertCtrl;
        this.jeuxVideoRec = jeuVideoService.recJeuVideo.slice();
    }
    JeuxVideoPage.prototype.ngOnInit = function () {
        this.jeuxVideoRec = this.shuffle(this.jeuxVideoRec);
    };
    JeuxVideoPage.prototype.shuffle = function (array) {
    ...
    JeuxVideoPage.prototype.supprimer = function (jv) {
                    ...
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                'Annuler',
                                {
                                    ...
                                    role: 'valider',
                                    handler: function () {
                                        var i = _this.jeuxVideoRec.indexOf(jv);
                                        _this.jeuxVideoRec.splice(i, 1);
                                        _this.jeuVideoService.delInRecJeuVideo(jv);
                                    }
                                }
                            ]
                        })];
...
//# sourceMappingURL=jeux-video-jeux-video-module-es5.js.map