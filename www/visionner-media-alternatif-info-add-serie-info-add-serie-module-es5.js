...
var InfoAddSeriePageRoutingModule = /** @class */ (function () {
    function InfoAddSeriePageRoutingModule() {
    }
    ...
    return InfoAddSeriePageRoutingModule;
}());
...
var InfoAddSeriePageModule = /** @class */ (function () {
    function InfoAddSeriePageModule() {
    }
...
var InfoAddSeriePage = /** @class */ (function () {
    function InfoAddSeriePage(navCtrl, serviceSerie, authService, activatedRoute) {
        this.navCtrl = navCtrl;
        this.serviceSerie = serviceSerie;
        this.authService = authService;
        this.activatedRoute = activatedRoute;
    }
    InfoAddSeriePage.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.paramMap.subscribe(function (paramMap) {
            if (!paramMap.has('idSerie')) {
                _this.navCtrl.navigateBack(['/selectionner-serie']);
                return;
            }
            _this.selectedSerie = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.serviceSerie.getInAllSerie(paramMap.get('idSerie')));
        });
        this.selectedSerie.note = 2;
        this.selectedSerie.vuEntierement = true;
    };
    InfoAddSeriePage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/selectionner-serie']);
    };
    InfoAddSeriePage.prototype.isFinished = function (s) {
        return !(s.dateF === undefined);
    };
    InfoAddSeriePage.prototype.Valider = function () {
    ...
    InfoAddSeriePage.prototype.passerNote = function (note) {
        this.selectedSerie.note = note;
    };
    InfoAddSeriePage.ctorParameters = function () { return [
...
//# sourceMappingURL=visionner-media-alternatif-info-add-serie-info-add-serie-module-es5.js.map