...
var InfoAddFilmPageRoutingModule = /** @class */ (function () {
    function InfoAddFilmPageRoutingModule() {
    }
    ...
    return InfoAddFilmPageRoutingModule;
}());
...
var InfoAddFilmPageModule = /** @class */ (function () {
    function InfoAddFilmPageModule() {
    }
...
var InfoAddFilmPage = /** @class */ (function () {
    function InfoAddFilmPage(navCtrl, activatedRoute, serviceFilm, authService) {
        this.navCtrl = navCtrl;
        this.activatedRoute = activatedRoute;
        this.serviceFilm = serviceFilm;
        this.authService = authService;
    }
    InfoAddFilmPage.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.paramMap.subscribe(function (paramMap) {
            if (!paramMap.has('idFilm')) {
                _this.navCtrl.navigateBack(['/selectionner-film']);
                return;
            }
            _this.selectedFilm = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.serviceFilm.getInAllFilm(paramMap.get('idFilm')));
        });
        this.selectedFilm.note = 2;
    };
    InfoAddFilmPage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/selectionner-film']);
    };
    InfoAddFilmPage.prototype.Valider = function () {
        this.serviceFilm.addInMyFilm(this.selectedFilm, this.authService.userId);
        this.navCtrl.navigateBack(['/medias/films']);
    };
    InfoAddFilmPage.prototype.passerNote = function (note) {
        this.selectedFilm.note = note;
    };
    InfoAddFilmPage.ctorParameters = function () { return [
...
//# sourceMappingURL=visionner-media-alternatif-info-add-film-info-add-film-module-es5.js.map