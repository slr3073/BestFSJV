...
let AjouterJeuVideoPageRoutingModule = class AjouterJeuVideoPageRoutingModule {
};
...
let AjouterJeuVideoPageModule = class AjouterJeuVideoPageModule {
};
...
let AjouterJeuVideoPage = class AjouterJeuVideoPage {
    constructor(genreService, editeurService, developpeurService, plateformeService, JeuVideoService, navCtrl, authService) {
        ...
        this.editeur = [...editeurService.editeur];
        this.developpeur = [...developpeurService.developpeur];
        this.plateformes = [...plateformeService.plateformes];
    }
    ngOnInit() { }
    goBack() {
    ...
    onChange1() {
        ...
        this.genreDispo2.splice(this.genreDispo2.findIndex((e) => e == this.jeuVideoEntered.genre1), 1);
    ...
    onChange2() {
        ...
        this.genreDispo1.splice(this.genreDispo1.findIndex((e) => e == this.jeuVideoEntered.genre2), 1);
...
AjouterJeuVideoPage.ctorParameters = () => [
...
let DeveloppeurService = class DeveloppeurService {
    constructor() {
        this.developpeur = [
            'Arkane Studios',
            'ATLUS',
...
let EditeurService = class EditeurService {
    constructor() {
        this.editeur = [
            '2K Games',
            'Activision-Blizzard',
...
let PlateformeService = class PlateformeService {
    constructor() {
        this.plateformes = [
            'PC',
            'XBOX ONE',
...
//# sourceMappingURL=ajouter-jeu-video-ajouter-jeu-video-module-es2015.js.map