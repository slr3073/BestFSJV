...
var InfoJeuVideoPageRoutingModule = /** @class */ (function () {
    function InfoJeuVideoPageRoutingModule() {
    }
    ...
    return InfoJeuVideoPageRoutingModule;
}());
...
var InfoJeuVideoPageModule = /** @class */ (function () {
    function InfoJeuVideoPageModule() {
    }
...
var InfoJeuVideoPage = /** @class */ (function () {
    function InfoJeuVideoPage(navCtrl, serviceJeuVideo, activatedRoute) {
        this.navCtrl = navCtrl;
        this.serviceJeuVideo = serviceJeuVideo;
        this.activatedRoute = activatedRoute;
    }
    InfoJeuVideoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.paramMap.subscribe(function (paramMap) {
            if (!paramMap.has('idJeuVideo')) {
                _this.navCtrl.navigateBack(['/medias/jeux-video']);
                return;
            }
            _this.selectedJeuVideo = _this.serviceJeuVideo.getInMyJeuVideo(paramMap.get('idJeuVideo'));
        });
    };
    InfoJeuVideoPage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/medias/jeux-video']);
    };
    InfoJeuVideoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=visionner-media-classique-info-jeu-video-info-jeu-video-module-es5.js.map