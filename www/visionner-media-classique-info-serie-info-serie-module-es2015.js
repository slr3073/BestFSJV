...
let InfoSeriePageRoutingModule = class InfoSeriePageRoutingModule {
};
...
let InfoSeriePageModule = class InfoSeriePageModule {
};
...
let InfoSeriePage = class InfoSeriePage {
    constructor(navCtrl, serviceSerie, activatedRoute) {
    ...
    ngOnInit() {
        this.activatedRoute.paramMap.subscribe((paramMap) => {
            ...
            this.selectedSerie = this.serviceSerie.getInMySerie(paramMap.get('idSerie'));
        });
    }
    goBack() {
        this.navCtrl.navigateBack(['/medias/series']);
...
//# sourceMappingURL=visionner-media-classique-info-serie-info-serie-module-es2015.js.map