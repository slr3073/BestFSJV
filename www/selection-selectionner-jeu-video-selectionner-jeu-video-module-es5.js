...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return Promise.all(/*! import() | ajouter-jeu-video-ajouter-jeu-video-module */[__webpack_require__.e("common"), __webpack_require__.e("ajouter-jeu-video-ajouter-jeu-video-module")]).then(__webpack_require__.bind(null, /*! ./ajouter-jeu-video/ajouter-jeu-video.module */ "./src/app/selection/selectionner-jeu-video/ajouter-jeu-video/ajouter-jeu-video.module.ts")).then(function (m) { return m.AjouterJeuVideoPageModule; }); }
    }
];
var SelectionnerJeuVideoPageRoutingModule = /** @class */ (function () {
    function SelectionnerJeuVideoPageRoutingModule() {
    }
    ...
    return SelectionnerJeuVideoPageRoutingModule;
}());
...
var SelectionnerJeuVideoPageModule = /** @class */ (function () {
    function SelectionnerJeuVideoPageModule() {
    }
    ...
    return SelectionnerJeuVideoPageModule;
}());
...
var SelectionnerJeuVideoPage = /** @class */ (function () {
    function SelectionnerJeuVideoPage(jeuxVideoService, navCtrl) {
        this.jeuxVideoService = jeuxVideoService;
        this.navCtrl = navCtrl;
        this.jeuxVideo = jeuxVideoService.jeuVideoNonJoue.slice();
    }
    SelectionnerJeuVideoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.JeuVideoSub = this.jeuxVideoService.jeuVideoNonJoueChanged.subscribe(function (jeuvideo) {
            _this.jeuxVideo = jeuvideo;
        });
    };
    SelectionnerJeuVideoPage.prototype.ngOnDestroy = function () {
        this.JeuVideoSub.unsubscribe();
    };
    SelectionnerJeuVideoPage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/medias/jeux-video']);
    };
    SelectionnerJeuVideoPage.prototype.goToAjouter = function () {
        this.navCtrl.navigateForward(['/selectionner-jeu-video/ajouter-jeu-video']);
    };
    SelectionnerJeuVideoPage.prototype.showInfo = function (id) {
        this.navCtrl.navigateForward(['/info-add-jeu-video/' + id]);
    };
    SelectionnerJeuVideoPage.ctorParameters = function () { return [
    ...
    return SelectionnerJeuVideoPage;
}());
...
//# sourceMappingURL=selection-selectionner-jeu-video-selectionner-jeu-video-module-es5.js.map