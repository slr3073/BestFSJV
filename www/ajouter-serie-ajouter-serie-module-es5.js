...
var AjouterSeriePageRoutingModule = /** @class */ (function () {
    function AjouterSeriePageRoutingModule() {
    }
    ...
    return AjouterSeriePageRoutingModule;
}());
...
var AjouterSeriePageModule = /** @class */ (function () {
    function AjouterSeriePageModule() {
    }
...
var AjouterSeriePage = /** @class */ (function () {
    function AjouterSeriePage(navCtrl, genreService, serviceSerie, authService) {
    ...
    AjouterSeriePage.prototype.ngOnInit = function () { };
    AjouterSeriePage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/selectionner-serie']);
    };
    AjouterSeriePage.prototype.changeAnneeMin = function () {
        this.anneeMin = this.serieEntered.dateS.toString().substring(0, 4);
    };
    AjouterSeriePage.prototype.changeAnneeMax = function () {
        if (!(this.serieEntered.dateF == null)) {
            this.anneeMax = this.serieEntered.dateF.toString().substring(0, 4);
        }
    };
    AjouterSeriePage.prototype.verification = function (form) {
    ...
    AjouterSeriePage.prototype.Valider = function (form) {
    ...
    AjouterSeriePage.prototype.changeState = function () {
...
//# sourceMappingURL=ajouter-serie-ajouter-serie-module-es5.js.map