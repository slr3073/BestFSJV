...
var FilmsPageRoutingModule = /** @class */ (function () {
    function FilmsPageRoutingModule() {
    }
...
var FilmsPage = /** @class */ (function () {
    function FilmsPage(navCtrl, filmService) {
        this.navCtrl = navCtrl;
        this.filmService = filmService;
        this.mesFilm = filmService.myFilm.slice();
    }
    FilmsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.filmSub = this.filmService.myFilmChanged.subscribe(function (film) {
            _this.mesFilm = film;
        });
    };
    FilmsPage.prototype.ngOnDestroy = function () {
        this.filmSub.unsubscribe();
    };
    FilmsPage.prototype.goToAjouter = function () {
        this.navCtrl.navigateForward(['/medias/films/ajouter']);
    };
    FilmsPage.prototype.showInfo = function (id) {
        this.navCtrl.navigateForward(['/info-film/' + id]);
    };
    FilmsPage.ctorParameters = function () { return [
...
var FilmsPage = /** @class */ (function () {
    function FilmsPage(filmService, alertCtrl) {
        this.filmService = filmService;
        this.alertCtrl = alertCtrl;
        this.filmsRec = this.filmService.recFilm.slice();
        this.filmsRec = this.shuffle(this.filmsRec);
    }
    FilmsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.filmSub = this.filmService.recFilmChanged.subscribe(function (film) {
            _this.filmsRec = film;
        });
    };
    FilmsPage.prototype.ngOnDestroy = function () {
    ...
    FilmsPage.prototype.shuffle = function (array) {
    ...
    FilmsPage.prototype.supprimer = function (f) {
                    ...
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                'Annuler',
                                {
                                    ...
                                    role: 'valider',
                                    handler: function () {
                                        var i = _this.filmsRec.indexOf(f);
                                        _this.filmsRec.splice(i, 1);
                                        _this.filmService.delInRecFilm(f);
                                    }
                                }
                            ]
                        })];
...
//# sourceMappingURL=films-films-module-es5.js.map