...
var InfoAddJeuVideoPageRoutingModule = /** @class */ (function () {
    function InfoAddJeuVideoPageRoutingModule() {
    }
    ...
    return InfoAddJeuVideoPageRoutingModule;
}());
...
var InfoAddJeuVideoPageModule = /** @class */ (function () {
    function InfoAddJeuVideoPageModule() {
    }
    ...
    return InfoAddJeuVideoPageModule;
}());
...
var InfoAddJeuVideoPage = /** @class */ (function () {
    function InfoAddJeuVideoPage(navCtrl, serviceJeuVideo, activatedRoute, authService) {
        this.navCtrl = navCtrl;
        this.serviceJeuVideo = serviceJeuVideo;
        this.activatedRoute = activatedRoute;
        this.authService = authService;
    }
    InfoAddJeuVideoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.paramMap.subscribe(function (paramMap) {
            if (!paramMap.has('idJeuVideo')) {
                _this.navCtrl.navigateBack(['/selectionner-jeu-video']);
                return;
            }
            _this.selectedJeuVideo = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.serviceJeuVideo.getInAllJeuVideo(paramMap.get('idJeuVideo')));
        });
        this.selectedJeuVideo.note = 2;
    };
    InfoAddJeuVideoPage.prototype.goBack = function () {
        this.navCtrl.navigateBack(['/selectionner-jeu-video']);
    };
    InfoAddJeuVideoPage.prototype.Valider = function () {
    ...
    InfoAddJeuVideoPage.prototype.passerNote = function (note) {
        this.selectedJeuVideo.note = note;
    };
    InfoAddJeuVideoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=visionner-media-alternatif-info-add-jeu-video-info-add-jeu-video-module-es5.js.map